...
### <span style="color: #1565C0;">Part 1: How the Rules are Enforced (LOS 90.a)</span>
...
#### <span style="color: #6A1B9A;">How Does an Inquiry Start?</span>
...
#### <span style="color: #6A1B9A;">What Happens During the Inquiry?</span>

Here's a simplified flowchart of the process:

```mermaid
graph TD
    A[Inquiry Triggered] --> B{PC Staff Conducts Inquiry};
    B --> C[Interviews, Info Requests, Document Review];
    C --> D{Violation?};
    D -- No --> E[Case Dropped];
    D -- Yes --> F[Staff Proposes Sanction];
    F --> G{Candidate/Member Accepts?};
    G -- Yes --> H[Sanction Imposed, Case Closed];
    G -- No --> I[Case Referred to Disciplinary Review Panel];
    I --> J[Panel Hearing];
    J --> H;

    style A fill:#FFF9E6,stroke:#F57C00
    style E fill:#E8F5E9,stroke:#4CAF50
    style H fill:#FFCCCB,stroke:#D32F2F
```
...
### <span style="color: #1565C0;">Part 2: The Code of Ethics (LOS 90.b)</span>
...
### <span style="color: #1565C0;">Part 3: The Standards of Professional Conduct (LOS 90.b & 90.c)</span>
