...
### <span style="color: #1565C0;">Part 1: Standard II(A) - Material Nonpublic Information (MNPI) 🤫</span>
...
graph TD
    subgraph Legend
        P[Public Info]
        NM-NP[Non-Material Nonpublic Info]
        MNPI[Material Nonpublic Info]
    end

    subgraph OK - The Mosaic Theory
        A(Company 10-K ) -- Analyst Gathers --> C(Analyst's Material Conclusion);
        B(Talks to suppliers ) -- Analyst Gathers --> C;
...
### <span style="color: #1565C0;">Part 2: Standard II(B) - Market Manipulation 🌪️</span>
