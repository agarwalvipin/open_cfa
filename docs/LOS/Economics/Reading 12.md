...
### <span style="color: #1565C0;">Part 1: To Sell or To Shut Down? - The Rules of Survival (LOS 12.a)</span>

Every business, regardless of its market, faces two critical questions:

#### <span style="color: #6A1B9A;">1.1 Breakeven and Shutdown Rules</span>
...
#### <span style="color: #6A1B9A;">1.2 Economies and Diseconomies of Scale</span>
...
### <span style="color: #1565C0;">Part 2: The Four Arenas of Competition 🏟️ (LOS 12.b)</span>

Every firm competes in one of four market structures. This table is your ultimate cheat sheet.

#### <span style="color: #6A1B9A;">2.1 Market Structure Comparison</span>
...
### <span style="color: #1565C0;">Part 3: Monopolistic Competition - Many Choices, Small Differences ☕ (LOS 12.c)</span>
...
#### <span style="color: #6A1B9A;">3.1 Key Features</span>

* **A large number of firms, slightly differentiated products, and low barriers to entry.**
...
#### <span style="color: #6A1B9A;">3.2 Short-Run vs. Long-Run</span>
...
### <span style="color: #1565C0;">Part 4: Oligopoly - The Game of Titans ♟️ (LOS 12.d)</span>
...
#### <span style="color: #6A1B9A;">4.1 Models of Oligopoly Behavior</span>

Because firms are interdependent, we need different models to predict their behavior.

* **Kinked Demand Curve Model:** Assumes competitors will **follow a price cut** but **ignore a price increase**. This creates a "kink" in the demand curve and explains why prices in an oligopoly can be very stable.
* **Cournot Model:** Each firm assumes its rivals' output is fixed and chooses its own profit-maximizing output level. In the end, they share the market.
* **Nash Equilibrium (Game Theory):** A situation where no single player can do better by changing their own strategy, given what the other players are doing. Often, the Nash equilibrium for oligopolies is for all firms to charge a lower price and make less profit than they could if they all colluded. Cheating on a collusive agreement is often the dominant strategy.
* **Dominant Firm Model:** One firm is so big and efficient (the "dominant firm") that it effectively sets the market price. The smaller firms ("fringe firms") act as price-takers at that price. Think of De Beers in the diamond market for many years.
...
### <span style="color: #1565C0;">Part 5: Identifying Market Structures - The Detective Work 🕵️‍♀️ (LOS 12.e)</span>
...
#### <span style="color: #6A1B9A;">5.1 Market Concentration Measures</span>

* **N-Firm Concentration Ratio:** The simplest measure. It's the sum of the market shares of the largest 'N' firms in an industry (e.g., the 4-firm ratio).
...
* **Herfindahl-Hirschman Index (HHI):** A more sensitive measure. It's the sum of the *squares* of the market shares of all firms in the industry.
...
#### <span style="color: #6A1B9A;">5.2 Limitations of Concentration Measures</span>
...
### <span style="color: #00838F;">5.3 Global & Local Context 🌍</span>

* **Global Example:** U.S. telecom market is a classic oligopoly, with AT&T, Verizon, and T-Mobile controlling most of the market. Regulators use HHI to monitor mergers.
* **Indian Example:** The Indian telecom sector saw a shift from many players to a few dominant ones (Jio, Airtel, Vi), increasing market concentration and changing competitive dynamics.
...
* **Shutdown Rule:** 
  * **Short Run:** Shut down if **Price < AVC**.
  * **Long Run:** Exit if **Price < ATC**.
