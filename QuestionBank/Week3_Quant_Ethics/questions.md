# 📚 Week 3 – Ethics & Quantitative Methods (42 Questions)
...
**Correct Answer: B**  
The CFA Code requires adherence to the stricter of local law or the CFA Standards. Insider trading violates Standard I(A).
...
**Correct Answer: B**  
Standard I(B) requires analysts to avoid conflicts or disclose them.
...
**Correct Answer: B**  
Presenting another’s work as your own is misrepresentation.
...
**Correct Answer: B**  
Any dishonest behavior can damage professional reputation.
...
**Correct Answer: B**  
Disclosure to employer is required under Standard I(B).
...
**Correct Answer: B**  
Material + nonpublic = violation if used.
...
**Correct Answer: C**  
Standard III(E) allows breaking confidentiality only when required by law.
...
**Correct Answer: B**  
Members must not solicit clients or coworkers before leaving.
...
**Tags**: `#Ethics` `#Suitability` `#Week3` `#Easy`
...
**Correct Answer: B**  
2 and 5 both appear twice = **bimodal**
...
Oops! That’s actually **Answer: A**  
🔁 Correction: Sample variance = **4**
...
**Correct Answer: B**  
Mean is pulled left = **Mean < Median**
...
**Correct Answer: A**  
Lower standard deviation = higher Sharpe if return equal
...
**Correct Answer: B**  
Geometric mean accounts for compounding and volatility.
...
**Correct Answer: B**  
If A and B are mutually exclusive: P(A or B) = P(A) + P(B) = 0.4 + 0.3 = **0.7**
...
**Correct Answer: A**  
For independent events: P(A and B) = P(A) × P(B) = 0.5 × 0.6 = **0.30**
...
**Correct Answer: A**  
P(C) = P(A)×P(C|A) + P(B)×P(C|B) = 0.4×0.2 + 0.6×0.1 = **0.14**
...
**Tags**: `#Quant` `#ExpectedValue` `#Week3` `#Medium`

<details>
<summary>✅ Answer & Explanation</summary>

**Correct Answer: A**  
E(X) = 0.6×100 + 0.4×50 = 60 + 20 = **$80**
...
**Correct Answer: C**  
E(X) = 4.4  
Var = Σ[P(x)(x – E(X))²] = 0.4(2–4.4)² + 0.6(6–4.4)² = 2.304 + 2.496 = **4.8**
...
**Correct Answer: A**  
Bayes' calculation results in ~47% due to low base rate.
