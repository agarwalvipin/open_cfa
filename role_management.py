...
def show_role_based_sidebar(user_uid):
    ...
    if check_user_access(user_uid, 'student'):
        ...
        if st.sidebar.button("Dashboard", type="primary" if st.session_state.current_page == 'dashboard' else "secondary", key="nav_dashboard"):
            st.session_state.current_page = 'dashboard'
            st.rerun()
        
        if st.sidebar.button("Create Quiz", type="primary" if st.session_state.current_page == 'create_quiz' else "secondary", key="nav_create_quiz"):
        ...
        if st.sidebar.button("Take Quiz", type="primary" if st.session_state.current_page == 'quiz' else "secondary", key="nav_take_quiz"):
            st.session_state.current_page = 'quiz'
            st.rerun()
        
        if st.sidebar.button("Load Questions", type="primary" if st.session_state.current_page == 'load_questions' else "secondary", key="nav_load_questions"):
